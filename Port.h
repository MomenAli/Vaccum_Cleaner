...
#define  SW_PRE_PORT GPIO_PORTB_DATA
#define  SW_PRE_DIR  GPIO_PORTB_DIR
#define  SW_PRE_PIN  PIN_2
//LED FOR PRESSURE ALARM  
#define  LED_PRE_ALARM_PORT GPIO_PORTB_DATA
#define  LED_PRE_ALARM_DIR  GPIO_PORTB_DIR
#define  LED_PRE_ALARM_PIN  PIN_3
